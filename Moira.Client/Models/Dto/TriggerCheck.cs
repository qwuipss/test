...
#nullable enable
        public global::Moira.Client.Models.Moira.MaintenanceInfo? MaintenanceInfo { get; set; }
#nullable restore
#else
        public global::Moira.Client.Models.Moira.MaintenanceInfo MaintenanceInfo { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Moira.Client.Models.Dto.TriggerCheck_metrics? Metrics { get; set; }
#nullable restore
#else
        public global::Moira.Client.Models.Dto.TriggerCheck_metrics Metrics { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Moira.Client.Models.Dto.TriggerCheck_metrics_to_target_relation? MetricsToTargetRelation { get; set; }
#nullable restore
#else
        public global::Moira.Client.Models.Dto.TriggerCheck_metrics_to_target_relation MetricsToTargetRelation { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Moira.Client.Models.Dto.TriggerCheck"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Moira.Client.Models.Dto.TriggerCheck CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Moira.Client.Models.Dto.TriggerCheck();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "maintenance_info", n => { MaintenanceInfo = n.GetObjectValue<global::Moira.Client.Models.Moira.MaintenanceInfo>(global::Moira.Client.Models.Moira.MaintenanceInfo.CreateFromDiscriminatorValue); } },
                { "metrics", n => { Metrics = n.GetObjectValue<global::Moira.Client.Models.Dto.TriggerCheck_metrics>(global::Moira.Client.Models.Dto.TriggerCheck_metrics.CreateFromDiscriminatorValue); } },
                { "metrics_to_target_relation", n => { MetricsToTargetRelation = n.GetObjectValue<global::Moira.Client.Models.Dto.TriggerCheck_metrics_to_target_relation>(global::Moira.Client.Models.Dto.TriggerCheck_metrics_to_target_relation.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Moira.Client.Models.Moira.MaintenanceInfo>("maintenance_info", MaintenanceInfo);
            writer.WriteObjectValue<global::Moira.Client.Models.Dto.TriggerCheck_metrics>("metrics", Metrics);
            writer.WriteObjectValue<global::Moira.Client.Models.Dto.TriggerCheck_metrics_to_target_relation>("metrics_to_target_relation", MetricsToTargetRelation);
