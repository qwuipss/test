...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Moira.ApiClient.Models.Dto.TriggerCheck_metrics? Metrics { get; set; }
#nullable restore
#else
        public global::Moira.ApiClient.Models.Dto.TriggerCheck_metrics Metrics { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Moira.ApiClient.Models.Dto.TriggerCheck_metrics_to_target_relation? MetricsToTargetRelation { get; set; }
#nullable restore
#else
        public global::Moira.ApiClient.Models.Dto.TriggerCheck_metrics_to_target_relation MetricsToTargetRelation { get; set; }
#endif
...
#nullable restore
        ...
        public static global::Moira.ApiClient.Models.Dto.TriggerCheck CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Moira.ApiClient.Models.Dto.TriggerCheck();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "metrics", n => { Metrics = n.GetObjectValue<global::Moira.ApiClient.Models.Dto.TriggerCheck_metrics>(global::Moira.ApiClient.Models.Dto.TriggerCheck_metrics.CreateFromDiscriminatorValue); } },
                { "metrics_to_target_relation", n => { MetricsToTargetRelation = n.GetObjectValue<global::Moira.ApiClient.Models.Dto.TriggerCheck_metrics_to_target_relation>(global::Moira.ApiClient.Models.Dto.TriggerCheck_metrics_to_target_relation.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Moira.ApiClient.Models.Dto.TriggerCheck_metrics>("metrics", Metrics);
            writer.WriteObjectValue<global::Moira.ApiClient.Models.Dto.TriggerCheck_metrics_to_target_relation>("metrics_to_target_relation", MetricsToTargetRelation);
